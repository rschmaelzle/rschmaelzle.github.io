...
<div class="profile-container">
    ...
    <div class="profile-sidebar">
        <!-- The text-align wrapper now works because we changed the CSS below -->
        <div style="text-align: center;">
            <img src="https://www.ralfschmaelzle.net/wp-content/uploads/2023/04/AudienceBrain.jpg" alt="Ralf Schmälzle" class="profile-img">
        </div>
...
.profile-img {
    ...
    /* CHANGED: 'inline-block' allows the parent div to center it properly */
